...
$(document).ready(function () {
    $("#AddPerson").click(function () {
        ...
        var RoomNumberHTML = '<input class="form-control" placeholder="Room Number" type="text" name="EmployeesMisc[' + i + '].RN" value="" />';
        $('#EmployeeSection').append('<div class="row ' + i + '"><div class= "col">' + FNameHTML + '</div><div class= "col">' + LNameHTML + '</div><div class= "col">' + RoomNumberHTML + '</div></div>'); 
    });
