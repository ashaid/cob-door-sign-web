...
$(document).ready(function () {
    $("#AddPerson").click(function () {
        ...
        var SecondTitle = '    <input class="form-control" placeholder="Second Title" type="text" name="EmployeesOffice[' + i + '].SecondTitle" value="" />';
        var Professorship = '    <input class="form-control" placeholder="Professorship" type="text" name="EmployeesOffice[' + i + '].Professorship" value="" />';
